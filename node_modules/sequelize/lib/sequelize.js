...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    if (arguments.length === 1 && typeof database === "object") {
      ...
      if (
        ...
        urlParts.pathname &&
        urlParts.pathname.indexOf("/:memory") !== 0
      ) {
    ...
    if (
      ["", null, false].indexOf(config.password) > -1 ||
  ...
  query(sql, options) {
    ...
    return Promise.try(() => {
      ...
      if (options.bind) {
        const bindSql = this.dialect.Query.formatBindParameters(
          sql,
          options.bind,
          this.options.dialect
        );
      ...
      options = _.defaults(options, {
        logging: this.options.hasOwnProperty("logging")
          ? this.options.logging
          : console.log,
        searchPath: this.options.hasOwnProperty("searchPath")
      ...
      if (!options.match.test(this.config.database)) {
        return Promise.reject(
          new Error(
            ...
            }" does not match sync match parameter "${options.match}"`
          )
        );
      }
    }
  ...
  authenticate(options) {
    return this.query(
      ...
      _.assign({ raw: true, plain: true }, options)
    ).return();
  }
  ...
  static set cls(ns) {
    Utils.deprecate(
      "Sequelize.cls should not be set directly. Use Sequelize.useCLS()."
    );
    this.useCLS(ns);
  }
...
Sequelize.prototype.literal = Sequelize.asIs = Sequelize.prototype.asIs =
  Sequelize.literal;
Sequelize.prototype.and = Sequelize.and;
Sequelize.prototype.or = Sequelize.or;
Sequelize.prototype.json = Sequelize.json;
Sequelize.prototype.where = Sequelize.condition = Sequelize.prototype.condition =
  Sequelize.where;
